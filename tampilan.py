...
def init_tampilan_db():
    ...
    try:
        ...
        print(f"❌ Error initializing tampilan db: {e}")
...
def get_tampilan_by_website_id(website_id):
    ...
    try:
        ...
        print(f"❌ Error in get_tampilan_by_website_id: {e}")
        return None
...
def create_or_update_tampilan(website_id, data):
    ...
    try:
        ...
        print(f"❌ Error in create_or_update_tampilan: {e}")
        return None
...
def save_bank_accounts(tampilan_id, banks):
    ...
    try:
        ...
        print(f"❌ Error in save_bank_accounts: {e}")
        return False
...
def save_ewallet_accounts(tampilan_id, ewallets):
    ...
    try:
        ...
        print(f"❌ Error in save_ewallet_accounts: {e}")
        return False
...
def save_crypto(tampilan_id, crypto_data):
    ...
    try:
        ...
        print(f"❌ Error in save_crypto: {e}")
        return False
